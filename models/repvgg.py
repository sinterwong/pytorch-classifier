...
def create_RepVGG_A0(deploy=False, num_classes=1000, pretrained_path=None):
    """ create RepVGG A0
    """
    return _repvgg(blocks=[2, 4, 14, 1], width_multiplier=[0.75, 0.75, 0.75, 2.5], 
                   deploy=deploy, override_groups_map=None, num_classes=num_classes, pretrained=pretrained_path)

def create_RepVGG_A1(deploy=False, num_classes=1000, pretrained_path=None):
    """ create RepVGG A1
    """
    return _repvgg(blocks=[2, 4, 14, 1], width_multiplier=[1, 1, 1, 2.5], 
                   deploy=deploy, override_groups_map=None, num_classes=num_classes, pretrained=pretrained_path)

def create_RepVGG_A2(deploy=False, num_classes=1000, pretrained_path=None):
    """ create RepVGG A2
    """
    return _repvgg(blocks=[2, 4, 14, 1], width_multiplier=[1.5, 1.5, 1.5, 2.75], 
                   deploy=deploy, override_groups_map=None, num_classes=num_classes, pretrained=pretrained_path)

def create_RepVGG_B0(deploy=False, num_classes=1000, pretrained_path=None):
    return _repvgg(blocks=[4, 6, 16, 1], width_multiplier=[1, 1, 1, 2.5], 
                   deploy=deploy, override_groups_map=None, num_classes=num_classes, pretrained=pretrained_path)

def create_RepVGG_B1(deploy=False, num_classes=1000, pretrained_path=None):
...
def create_RepVGG_B2(deploy=False, num_classes=1000, pretrained_path=None):
...
def create_RepVGG_B3(deploy=False, num_classes=1000, pretrained_path=None):
...
def create_RepVGG_C0(deploy=False, num_classes=1000, pretrained_path=None):
    """ create RepVGG C0
    """
    return _repvgg(blocks=[2, 4, 4, 1], width_multiplier=[0.5, 0.5, 0.5, 0.75], 
                   deploy=deploy, override_groups_map=None, num_classes=num_classes, pretrained=pretrained_path)

def create_RepVGG_C1(deploy=False, num_classes=1000, pretrained_path=None):
    """ create RepVGG C1
    """
