...
class SqueezeExcitation(nn.Module):
    ...
    def _scale(self, input: Tensor, inplace: bool) -> Tensor:
        ...
        return F.hardtanh(scale, inplace=inplace)
...
def _mobilenet_v3_model(
    ...
    **kwargs: Any
    ...
    model = MobileNetV3(inverted_residual_setting,
                        last_channel, num_classes=num_classes, **kwargs)
    if pretrained and not os.path.exists(pretrained):
        ...
        temp_dict = {k: v for k, v in state_dict.items() if k in model_dict}
...
def mobilenet_v3_small(pretrained: bool = False, num_classes: int = 1000, progress: bool = True, **kwargs: Any) -> MobileNetV3:
    ...
    `"Searching for MobileNetV3" <https://arxiv.org/abs/1905.02244>`_.
    Args:
        pretrained (str): If path exists, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
...
if __name__ == "__main__":
    pretrained = "/home/wangjq/wangxt/workspace/pytorch-classifier/weights/mobilenet_v3_small-047dcff4.pth"
    mobilenetv3 = mobilenet_v3_small(pretrained, 5, True)
